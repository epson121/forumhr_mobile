/* TO DO
 * postaviti buffering kod ucitavanja
 * slika za subtopics -> ako nema subsa, nemoj ju ni stavljati
 * popraviti izgled "Druzenje &amp; kava"
 */
...
public class TopicsActivity extends Activity {
	...
	public class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageView subImage = (ImageView) v.findViewById(R.id.subtopics);
			...
			subImage.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					//alert dialog sa izborom podforuma
					
					Toast.makeText(getApplicationContext(), "subtopics: " + pos, Toast.LENGTH_SHORT).show();
				}
			});
